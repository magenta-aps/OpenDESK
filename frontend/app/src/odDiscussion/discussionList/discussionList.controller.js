...
angular
  ...
  .controller('DiscussionController', ['APP_CONFIG', '$scope', '$mdDialog', '$state', '$stateParams',
    '$interval', 'discussionService', 'nodeRefUtilsService',
    'siteService', 'UserService', DiscussionController])

function DiscussionController (APP_CONFIG, $scope, $mdDialog, $state, $stateParams, $interval,
